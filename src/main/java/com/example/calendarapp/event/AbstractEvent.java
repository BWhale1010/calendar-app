...
public abstract class AbstractEvent implements Event {
    ...
    public ZonedDateTime getStartAt(){return  this.startAt;}
    public ZonedDateTime getEndAt(){return  this.endAt;}

    public void validataAndUpdate(AbstractAuditableEvent update){
        if(deletedYn == true){
